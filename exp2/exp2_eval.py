...
vali_file = ["./ds_vali_ans_ne.csv",
              "./lam_vali_ans_ne.csv",
              "./qw_vali_ans_ne.csv",
              "./ori_vali_ans_ne.csv"]

base_model_path = pre_model[0]
data_path = vali_file[0]
tok_path = "./tokenizer"
...
cus_model = CustomLlamaModel(tokenizer, base_model_path, peft_path, trans_path)
# cus_model = torch.nn.DataParallel(cus_model)
cus_model.to(device)
